...
u16 MainMusicComboTable[][2] = {
    ...
    [ANIM_MUSIC_COMBO_WILL] = { 0x1D, SEQ_GS_VS_SHITENNO },
    [ANIM_MUSIC_COMBO_KOGA] = { 0x1E, SEQ_GS_VS_SHITENNO },
    [ANIM_MUSIC_COMBO_BRUNO] = { 0x1F, SEQ_GS_VS_SHITENNO },
    [ANIM_MUSIC_COMBO_KAREN] = { 0x20, SEQ_GS_VS_SHITENNO },
    ...
    [ANIM_MUSIC_COMBO_PETREL] = { 0x28, SEQ_GS_VS_ROCKET_EXEC },
    [ANIM_MUSIC_COMBO_PROTON] = { 0x29, SEQ_GS_VS_ROCKET_EXEC },
    [ANIM_MUSIC_COMBO_ARCHER] = { 0x2A, SEQ_GS_VS_ROCKET_EXEC },
    [ANIM_MUSIC_COMBO_ARIANA] = { 0x2B, SEQ_GS_VS_ROCKET_EXEC },
    [ANIM_MUSIC_COMBO_GIOVANNI] = { 0x2C, SEQ_GS_VS_ROCKET_EXEC },
...
u8 TrainerClassToMusicCombo[][2] = {
    ...
    // (***END OF VANILLA ENTRIES***)
    {TRAINERCLASS_NPC_TRAINER_ETHAN, ANIM_MUSIC_COMBO_ETHAN*4},
    {TRAINERCLASS_NPC_TRAINER_LYRA, ANIM_MUSIC_COMBO_LYRA*4},
    {TRAINERCLASS_CIPHER_ADMIN_GORIGAN, ANIM_MUSIC_COMBO_GORIGAN*4},
};
...
struct TrainerMusic sTrainerEncounterMusicParam[] = // cues which music sequence occurs upon eyes meeting
{
    ...
    {.class = TRAINERCLASS_PICNICKER, .music1 = SEQ_GS_EYE_GIRL_ALT, .music2 = SEQ_GS_EYE_GIRL_ALT},
    {.class = TRAINERCLASS_BUG_CATCHER, .music1 = SEQ_GS_EYE_BOY_ALT, .music2 = SEQ_GS_EYE_BOY_ALT},
    {.class = TRAINERCLASS_TWINS, .music1 = SEQ_GS_EYE_TWINS, .music2 = SEQ_GS_EYE_TWINS},
    {.class = TRAINERCLASS_HIKER, .music1 = SEQ_GS_EYE_HIKER, .music2 = SEQ_GS_EYE_HIKER},
    {.class = TRAINERCLASS_FISHERMAN, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_BLACK_BELT, .music1 = SEQ_GS_EYE_FIGHT, .music2 = SEQ_GS_EYE_FIGHT},
    ...
    {.class = TRAINERCLASS_ACE_TRAINER_M_GS, .music1 = SEQ_GS_EYE_ELITE, .music2 = SEQ_GS_EYE_ELITE},
    {.class = TRAINERCLASS_ACE_TRAINER_F_GS, .music1 = SEQ_GS_EYE_ELITE, .music2 = SEQ_GS_EYE_ELITE},
    ...
    {.class = TRAINERCLASS_BEAUTY, .music1 = SEQ_GS_EYE_LADY, .music2 = SEQ_GS_EYE_LADY},
    ...
    {.class = TRAINERCLASS_SKIER, .music1 = SEQ_GS_EYE_SPORT, .music2 = SEQ_GS_EYE_SPORT},
    ...
    {.class = TRAINERCLASS_BOARDER, .music1 = SEQ_GS_EYE_SPORT, .music2 = SEQ_GS_EYE_SPORT},
